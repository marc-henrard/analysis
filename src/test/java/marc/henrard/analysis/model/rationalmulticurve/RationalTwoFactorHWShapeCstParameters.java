 ...
 * <p>
 * The function b_0 as a HW shape. The function b_1 is the one implied by b_0 plus a constant. The function
 * b_2 is a constant. The constants c_1 and c_2 are the same for all indices.
 * 
 * @author Marc Henrard
 */
@BeanDefinition
public class RationalTwoFactorHWShapeCstParameters
  ...
  private RationalTwoFactorHWShapeCstParameters(
      double a1, 
      double a2, 
      double correlation, 
      double b00, 
  ...
  @Override
  public RationalTwoFactorHWShapeCstParameters withParameter(int parameterIndex, double newValue) {
    return new RationalTwoFactorHWShapeCstParameters(
  ...
  public double a2() {
    ...
    //------------------------- AUTOGENERATED START -------------------------
    /**
     * The meta-bean for {@code RationalTwoFactorHWShapeCstParameters}.
     * @return the meta-bean, not null
     */
    public static RationalTwoFactorHWShapeCstParameters.Meta meta() {
        return RationalTwoFactorHWShapeCstParameters.Meta.INSTANCE;
    }

    static {
        MetaBean.register(RationalTwoFactorHWShapeCstParameters.Meta.INSTANCE);
    }
     ...
     */
    public static RationalTwoFactorHWShapeCstParameters.Builder builder() {
        return new RationalTwoFactorHWShapeCstParameters.Builder();
    }

    @Override
    public RationalTwoFactorHWShapeCstParameters.Meta metaBean() {
        return RationalTwoFactorHWShapeCstParameters.Meta.INSTANCE;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && obj.getClass() == this.getClass()) {
            RationalTwoFactorHWShapeCstParameters other = (RationalTwoFactorHWShapeCstParameters) obj;
    ...
    public String toString() {
        ...
        buf.append("RationalTwoFactorHWShapeCstParameters{");
        int len = buf.length();
        toString(buf);
        if (buf.length() > len) {
    ...
    public static class Meta extends DirectMetaBean {
        ...
        private final MetaProperty<Double> a1 = DirectMetaProperty.ofImmutable(
                this, "a1", RationalTwoFactorHWShapeCstParameters.class, Double.TYPE);
        /**
         * The meta-property for the {@code a2} property.
         */
        private final MetaProperty<Double> a2 = DirectMetaProperty.ofImmutable(
                this, "a2", RationalTwoFactorHWShapeCstParameters.class, Double.TYPE);
        /**
        ...
        private final MetaProperty<TimeMeasurement> timeMeasure = DirectMetaProperty.ofImmutable(
                this, "timeMeasure", RationalTwoFactorHWShapeCstParameters.class, TimeMeasurement.class);
        /**
        ...
        private final MetaProperty<DiscountFactors> discountFactors = DirectMetaProperty.ofImmutable(
                this, "discountFactors", RationalTwoFactorHWShapeCstParameters.class, DiscountFactors.class);
        /**
         * The meta-property for the {@code valuationTime} property.
         */
        private final MetaProperty<LocalTime> valuationTime = DirectMetaProperty.ofImmutable(
                this, "valuationTime", RationalTwoFactorHWShapeCstParameters.class, LocalTime.class);
        /**
        ...
        private final MetaProperty<ZoneId> valuationZone = DirectMetaProperty.ofImmutable(
                this, "valuationZone", RationalTwoFactorHWShapeCstParameters.class, ZoneId.class);
        /**
         * The meta-properties.
         */
        ...
        @Override
        public RationalTwoFactorHWShapeCstParameters.Builder builder() {
            return new RationalTwoFactorHWShapeCstParameters.Builder();
        }

        @Override
        public Class<? extends RationalTwoFactorHWShapeCstParameters> beanType() {
            return RationalTwoFactorHWShapeCstParameters.class;
        }
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                case 3056:  // a1
                    return ((RationalTwoFactorHWShapeCstParameters) bean).getA1();
                case 3057:  // a2
                    return ((RationalTwoFactorHWShapeCstParameters) bean).getA2();
                case 1706464642:  // correlation
                    return ((RationalTwoFactorHWShapeCstParameters) bean).getCorrelation();
                case 95714:  // b00
                    return ((RationalTwoFactorHWShapeCstParameters) bean).getB00();
                case 100754:  // eta
                    return ((RationalTwoFactorHWShapeCstParameters) bean).getEta();
                case 101817675:  // kappa
                    return ((RationalTwoFactorHWShapeCstParameters) bean).getKappa();
                case 3118:  // c1
                    return ((RationalTwoFactorHWShapeCstParameters) bean).getC1();
                case 3119:  // c2
                    return ((RationalTwoFactorHWShapeCstParameters) bean).getC2();
                case 1642109393:  // timeMeasure
                    return ((RationalTwoFactorHWShapeCstParameters) bean).getTimeMeasure();
                case -91613053:  // discountFactors
                    return ((RationalTwoFactorHWShapeCstParameters) bean).getDiscountFactors();
                case 113591406:  // valuationTime
                    return ((RationalTwoFactorHWShapeCstParameters) bean).getValuationTime();
                case 113775949:  // valuationZone
                    return ((RationalTwoFactorHWShapeCstParameters) bean).getValuationZone();
            }
    ...
    //-----------------------------------------------------------------------
    /**
     * The bean-builder for {@code RationalTwoFactorHWShapeCstParameters}.
     */
    public static class Builder extends DirectFieldsBeanBuilder<RationalTwoFactorHWShapeCstParameters> {
         ...
         */
        protected Builder(RationalTwoFactorHWShapeCstParameters beanToCopy) {
        ...
        @Override
        public RationalTwoFactorHWShapeCstParameters build() {
            return new RationalTwoFactorHWShapeCstParameters(
                    a1,
                    a2,
                    correlation,
        ...
        public String toString() {
            StringBuilder buf = new StringBuilder(416);
            buf.append("RationalTwoFactorHWShapeCstParameters.Builder{");
            int len = buf.length();
            toString(buf);
            if (buf.length() > len) {
                buf.setLength(buf.length() - 2);
